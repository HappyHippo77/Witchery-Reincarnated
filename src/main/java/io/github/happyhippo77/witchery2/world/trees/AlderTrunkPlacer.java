...
public class AlderTrunkPlacer extends TrunkPlacer {
    ...
    public static final Codec<AlderTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            fillTrunkPlacerFields(instance).apply(instance, AlderTrunkPlacer::new));

    public AlderTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
    ...
    protected TrunkPlacerType<?> getType() {
        return ModPlacers.ALDER_TRUNK_PLACER;
    }
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, int height, BlockPos startPos, TreeFeatureConfig config) {
        ...
        this.branchSlope = 0.5D;
        this.scaleWidth = 0.5D;
        this.leafDensity = 0.5D;
        this.trunkSize = 1;
        this.heightLimitLimit = 7;
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        if(aint2[b1] == 0) {
            ...
            for(j = aint2[b1] + b4; i != j; i += b4) {
                ...
                if(k != Blocks.AIR && k != ModBlocks.ALDER_LEAVES) {
                    break;
                }
            }
